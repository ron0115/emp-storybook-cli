...
export const runStorybook = ({ configDir = path.resolve(__dirname, '../.storybook'), outputDir = '.out', command = 'build-storybook', commandParams = [''] }) => {
...
export const runBuild = async () => await runStorybook({
...
export const runDev = async () => await runStorybook({
